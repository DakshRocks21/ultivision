from MainApp.utils.constants import MODEL_GARDEN_PATH, LABELMAP_FILENAME, PREFERRED_FILENAME, DATA_PATH, PREFERRED_FILENAME_PATH
...
def download_model():
    ...
    file_list[0].GetContentFile(LABELMAP_FILENAME)
